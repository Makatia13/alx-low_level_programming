...
/**
 * check_elf - Verify if a file is in the ELF format.
 * @e_ident: A pointer to an array containing the ELF magic numbers.
 *
 * Description: This function checks whether the given file conforms
 * to the ELF standard. If the file is not in the ELF format,
 * it terminates the program with exit code 98.
 */
void check_elf(unsigned char *e_ident)
{
	int index;
...
/**
 * close_elf -t  Closes an ELF file.
 * @elf: The file descr'r of the ELF file.
 *
 ...
 * @argc: num of argmentss supplied to the program.
