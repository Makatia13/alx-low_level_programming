 ...
 *
 * Description:Now If the file is not an ELF file - exit code 98.
 */
void check_elf(unsigned char *e_ident)
{
	int index;
...
/**
 * print_magic -This  Prints the magic nums of an ELF header.
 * @e_ident:This is  pointer to an array containing the ELF magic nums.
 *
 ...
 *
 * Description: If the file it  cannot be closed - exit code 98.
 */
void close_elf(int elf)
{
	if (close(elf) == -1)
 ...
 * @argc: The num of argmentss supplied to the program.
